...
export default function AgentDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-great-blue">
      {/* Header */}
      <div className=" backdrop-blur-sm border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Welcome back, {userProfile?.displayName || "Agent"}!</h1>
